...
EasyNotes is open-source and you're welcome to contribute to it. You're encouraged to submit [pull requests](https://github.com/NoteXCommunity/note-x/pulls), [propose features and discuss issues](https://github.com/NoteXCommunity/note-x/issues).
